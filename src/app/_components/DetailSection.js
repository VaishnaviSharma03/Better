            ...
            <section className="section w-full pb-base lg:pb-12">
                <div className="m-auto flex max-w-screen-2xl flex-col items-center md:items-start gap-8 px-6 py-20 md:px-10 lg:gap-[60px]">
                    <div className="justify-left flex w-full max-w-lg flex-wrap gap-12 lg:gap-6 h-auto lg:max-w-none lg:items-end lg:justify-between">
                        <h1 className="font-bold text-textPrimary !text-6xl leading-heading m-0 p-0 md:text-2xl md:tracking-tight w-full max-w-lg tracking-tight">
                    ...
                    <div className="flex flex-row flex-wrap justify-center gap-8 lg:gap-6">
                        ...
                        <Link className="flex w-full max-w-lg cursor-pointer flex-col gap-8 rounded-md bg-[#eef7f1] px-6 py-5 md:flex-row md:[&>img]:h-[100%] md:[&>img]:max-w-[285px] md:gap-10 md:max-w-full md:justify-between md:px-12 md:py-8 lg:flex-1 lg:flex-col lg:basis-1/4 lg:justify-between lg:gap-6 lg:px-12 lg:py-[35px] lg:max-w-lg lg:[&>img]:max-w-none lg:[&:nth-child(2)>*]:flex-1 lg:[&:nth-child(2)>img]:h-[100%] lg:[&:nth-child(2)>img]:max-w-[285px] lg:[&:nth-child(2)]:max-w-none lg:[&:nth-child(2)]:basis-3/5 lg:[&:nth-child(2)]:flex-row lg:[&:nth-child(2)]:gap-10 lg:[&:nth-child(3)>*]:flex-1 lg:[&:nth-child(3)>img]:h-[100%] lg:[&:nth-child(3)>img]:max-w-[285px] lg:[&amp;:nth-child(3)]:max-w-none lg:[&amp;:nth-child(3)]:basis-3/5 lg:[&amp;:nth-child(3)]:flex-row-reverse lg:[&amp;:nth-child(3)]:gap-10" href="/b/heloc/">
                            <div className="flex flex-col gap-6">
                        ...
                        <Link className="flex w-full max-w-lg cursor-pointer flex-col gap-8 rounded-md bg-[#eef7f1] px-6 py-5 md:flex-row md:[&>img]:h-[100%] md:[&>img]:max-w-[285px] md:gap-10 md:max-w-full md:justify-between md:px-12 md:py-8 lg:flex-1 lg:flex-col lg:basis-1/4 lg:justify-between lg:gap-6 lg:px-12 lg:py-[35px] lg:max-w-lg lg:[&>img]:max-w-none lg:[&:nth-child(2)>*]:flex-1 lg:[&:nth-child(2)>img]:h-[100%] lg:[&:nth-child(2)>img]:max-w-[285px] lg:[&:nth-child(2)]:max-w-none lg:[&:nth-child(2)]:basis-3/5 lg:[&:nth-child(2)]:flex-row lg:[&:nth-child(2)]:gap-10 lg:[&:nth-child(3)>*]:flex-1 lg:[&:nth-child(3)>img]:h-[100%] lg:[&:nth-child(3)>img]:max-w-[285px] lg:[&:nth-child(3)]:max-w-none lg:[&:nth-child(3)]:basis-3/5 lg:[&:nth-child(3)]:flex-row-reverse lg:[&:nth-child(3)]:gap-10" href="https://www.bettercover.com">
                            <div className="flex flex-col gap-6">
                                <h4 className="font-bold leading-heading m-0 p-0 w-auto md:text-2xl text-xl md:tracking-normal tracking-normal text-backgroundInversePrimary lg:text-xl">Insurance</h4>
                                <div className="flex items-end justify-between">
                                    <div className="group">
                                    </div>
                                </div>
                            </div>
                            <Image alt="Insurance" width={200} height={200} className="w-full rounded-md object-cover h-[160px] md:h-[130px]" src="/Assets/image6.png" color="transparent" />
                        </Link>
                    </div>
                </div>
            </section>
            <hr className="border-t border-gray-400 my-0 pb-3"></hr>
        </>
    );
};
